...
struct AssignedParkingLotModel {
    ...
    static let arrParkingLotInfo: [AssignedParkingLotModel] = [
        AssignedParkingLotModel(imgParkingLot: "imgparking1", parkingId: "24582", parkingLotName: "Alpha mall", parkingLotAddress: "1280, St. NE, DC Road, 20001", oeratingHour: "6 AM to 11 PM", locationId: "A101", locationPhoneNo: "245-854-2145"),
